...
{
	//-------------------------------------------------------------------------
	// EXAMPLE 1. Create XML document and save to file
	//-------------------------------------------------------------------------
	...
	//-------------------------------------------------------------------------
	// EXAMPLE 2. Modify last XML document save to std::vector<std::string> and
	// then to file
	//-------------------------------------------------------------------------
	...
	if (out_file_2)
	{
		std::copy(std::cbegin(buffer), std::cend(buffer), 
			std::ostream_iterator<std::string>{out_file_2});
